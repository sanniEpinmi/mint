...
public class KafkaProducer {
    ...
    public void postBrand(String topic, String groupId, OrderEntity prmBrand){
        try {
    ...
    public void postBrandManufacturer(String topic, String groupId, ProductEntity prmBrandManufactuer){
        try {
